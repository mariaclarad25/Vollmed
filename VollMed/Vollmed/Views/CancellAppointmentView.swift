...
//  Vollmed
//
//  Created by Maria Clara Dias on 04/07/25.
//

import SwiftUI

struct CancellAppointmentView: View {
    ...
    func cancelAppointment() async {
        do {
            isAppointmentCancelled = try await service.cancellAppointment(appointmentID: appointmentID, reasonToCancel: reasonToCancel)
        } catch {
...
#Preview {
    CancellAppointmentView(appointmentID: "123")
}
